...
class AboutListAssignments(Koan):
    ...
    def test_parallel_assignments_with_sublists(self):
        ...
        #its a nested list so 1st name is equal to the nest listed
    ...
    def test_swapping_with_parallel_assignment(self):
        ...
        #as confusing as that was we reassiged the names
        #with listing the varible is different order

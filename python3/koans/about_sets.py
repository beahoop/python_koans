...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        #when setting a set it will kick out duplicates
        self.assertEqual({'Ramirez', 'Malcolm', 'MacLeod', 'Matunas'}, there_can_only_be_only_one)
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        #this is a set class below is key value pair or dict
        self.assertEqual(dict, {'one': 1, 'two': 2}.__class__)
        #even empty {} aren't a set python assumes they are a dict
    ...
    def test_convert_the_set_into_a_list_to_sort_it(self):
        ...
        # sort will turn a set into a sorted list
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        #from scotsmen minus all the same var of warrios and return just the one left in scotmans
        self.assertEqual({'Wallace', 'Willie', 'MacLeod', 'Leonidas'}
, scotsmen | warriors)
        #give both
        self.assertEqual({'MacLeod', 'Wallace'}, scotsmen & warriors)
        #give the var that are the same in both
        self.assertEqual({'Willie', 'Leonidas'}, scotsmen ^ warriors)
#give back the same that arent in both
    # ------------------------------------------------------------------

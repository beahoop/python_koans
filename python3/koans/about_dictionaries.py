...
class AboutDictionaries(Koan):
    ...
    def test_changing_dictionaries(self):
        ...
        #just filled in what one was key too
    ...
    def test_dictionary_is_unordered(self):
        ...
        #python can read the values and understand these are the
        #same dict just in different order
    ...
    def test_making_a_dictionary_from_a_sequence_of_keys(self):
        ...
        #this dict keys are the words and the value is 42

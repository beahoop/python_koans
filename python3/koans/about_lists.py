...
class AboutLists(Koan):
    def test_creating_lists(self):
        ...
        #empty_list is set to list()but nothing in () so its empty
    ...
    def test_list_literals(self):
        ...
        #with a key pair value if the key has no value
        #then you are setting the value when you say num[1:__] = 2

        nums.append(333)
        self.assertListEqual([1, 2, 333], nums)
        #appending is adding 333 to the end of the list
    ...
    def test_accessing_list_elements(self):
        ...
        #nom[whatever number you put here] is the index of the list
    def test_slicing_lists(self):
        ...
        #this is slicing by index, the 1st number is the
        #starting point, second is the ending point.
    ...
    def test_lists_and_ranges(self):
        ...
        #range does not go to the last number listed
...
#range is start, stop, step
    def test_insertions(self):
        ...
        #insert works with index of an array. Takes a number and then the
        #itme to be insterted
    ...
    def test_popping_lists(self):
        ...
        #pop can work with indexs or just pop off the last
        #item by default.. it will change the org list

...
class AboutStringManipulation(Koan):
    ...
    def test_formatted_values_can_be_shown_in_any_order_or_be_repeated(self):
        ...
        #filling in spots in the string with values
        #does this by which one comes 1st will be 0..like index
    ...
    def test_any_python_expression_may_be_interpolated(self):
        ...
        #used math!! instead of a varible

    def test_you_can_get_a_substring_from_a_string(self):
        string = "Bacon, lettuce and tomato"
        self.assertEqual('let', string[7:10])
        #caputring just part of the string
    ...
    def test_single_characters_can_be_represented_by_integers(self):
        ...
        #gives you a int for a string or character type
...
#joined the words but with spaces inbetween
